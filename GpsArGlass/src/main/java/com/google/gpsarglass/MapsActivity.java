...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Lancer la reconnaissance vocale automatiquement
    ...
    private void startVoiceRecognition() {
        ...
        intent.putExtra(RecognizerIntent.EXTRA_PROMPT, "Donnez une commande (bus, train, streetview)");
    ...
    private void showBusStops() {
        // Exemple : placer un marqueur fictif d'arrêt de bus
    ...
    private void openStreetView() {
        // Sur Glass XE, utiliser WebView pour Street View
        Toast.makeText(this, "Ouverture de Street View...", Toast.LENGTH_SHORT).show();
        Intent intent = new Intent(this, com.google.gpsarglass.StreetViewActivity.class);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        // Exemple : placer un marqueur à Sydney
